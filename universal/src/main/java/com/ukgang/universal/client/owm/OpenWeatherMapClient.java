...
public class OpenWeatherMapClient implements ClimateDataSource {
    ...
    public final Climate getWeather() {
    		String urlGetWeather = String.format(URL_FORMATTER, OWM_URL, QUERY_BY_REGION_NAME, SystemMetadata.getApiKey());
	...
	public final List<Climate> forcastClimateByCityId() {
		String urlForcastClimateByCityId = String.format(URL_FORMATTER, OWM_URL, FORCAST_BY_REGION_ID, SystemMetadata.getApiKey());
